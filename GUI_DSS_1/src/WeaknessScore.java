...
public class WeaknessScore {
    ...
    int[] departmentSorted;
    int[] departmentSortedDesc;
...
//        }
            ...
            this.departmentSorted = departmentSorted;
        
        return departmentSorted;
    }
    
    public int[] sortDesc(int[] department){
        department = dsshome.holland.departmentFiltered;
        ...
        for(int i = 0; i < score.length; i++){
            ...
            score[indexMax] = score[i];
            score[i] = temp;           
            departmentSorted[i] = department[indexMax]; 
        }
...
//        }
            ...
            this.departmentSortedDesc = departmentSorted;
